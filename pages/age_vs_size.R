  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      p("We obtained this information from Metadata: Chinook salmon",
        "age, sex, and length data from major rivers in Southeast Alaska,
        1988-2017."),
      ...
      p("The chart shows the salmon's change in size as their age develop.",
        ...
        "numerically discrete, so we cannot have a scatter plot. The average",
        "size allows us to obtain one result for each age inorder to format a",
        "line graph. Chilkat is the only river that has higher average size of",
        "salmon at the age 2 compared to 3 (for both male and female).",
        ...
        "data for that age whose length is 835mm. Apart from that, the graph",
        "looks like what we expected. Overall, the average size in male and",
        "female are very similar for all ages apart from the anomaly (age = 2",
