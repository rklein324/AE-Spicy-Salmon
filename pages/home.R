home_page <- tabPanel(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      The research question our team investigated was - Does early 
      ...
      This research is extremely valuable and relevant currently as 
      ...
      Therefore, through this analysis our research team hopes to shed light on
      the importance issue of salmon size reduction and propose 
      correlated reasons and potential solutions. 
      
      Data sets we used in the analysis:
